		...
		<script type="text/javascript">
			$(function(){
		        ...
		        $("#addbtn").click(function(){
					...
					if(r==true){
						if(""==id_stuname||""==prover_punish||""==content_punish){
		            	alert("所有内容是必填项目");
			            }else{
			            	var html = $.ajax({
			               	type: "POST",
			               	url: "add.php",
			               	data: "info_userid="+id_stuname+"&info_type=0"+"&info_proveins="+proveins_punish+"&info_prover="+prover_punish+"&info_content="+content_punish,
