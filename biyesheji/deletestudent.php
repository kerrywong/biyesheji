	...
	<div class="form_boxC">
		<table cellpadding="0" cellspacing="0" align="center">
			<form action="#" method="post">
				...
				<tr>
					<th width="100">身份</th>
					<td><div class="txtbox floatL" style="width:200px;"><input id="role_stu" name="" type="text" size="18" ></div></td>
				</tr>
				<tr>
					<th>所在班级</th>
				...
				<tr>
					<th>性别</th>
					<td>
						<div class="txtbox floatL" style="width:200px;"><input id="gender_stu" type="text" size="18" >
						<select id="gender_stu2" style="width:205px;height: 40px;" hidden>
...
//		            	console.log('hello');
			            ...
			            document.getElementById('work_stu').value="";
		...
		<script type="text/javascript">
			$(function(){
		        ...
		        $("#updatebtn").click(function(){
			        ...
			        var role_stuname=document.getElementById('role_stu').value;
			        var class_stuname=document.getElementById('class_stu').value;
			        var gender_stuname=document.getElementById('gender_stu').value;
					...
					if(r==true){
						if(""==id_stuname||""==pwd_stuname||""==role_stuname||""==class_stuname){
		            	alert("学号 密码 身份 所在班级是必填项目");
			            }else{
			            	var html = $.ajax({
			               	type: "POST",
			               	url: "update.php",
			               	data: "userid="+id_stuname+"&userpwd="+pwd_stuname+"&userrole=3"+"&userclass="+class_stuname+"&usergender="+gender_stuname+"&userimage="+image_stuname+"&username="
...
<?php
	...
	if(isset($_POST['id_user'])){
		...
		if(count($arr)==0){
			...
			echo "document.getElementById('role_stu').value='".$rolestring."';";
			...
			echo "document.getElementById('gender_stu').value='".$genderstring."';";
